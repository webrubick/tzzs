 ...
 * @version      2.1.0
 */
(function(){var f;f="ontouchstart"in window;(function(c,n,m){var l;l=function(){function d(a,b){this.options=c.extend(!1,{},this.Defaults,b);this.$element=c(a);this.$clone=null;this.$win=c(m);this.$doc=c(n);this.currentLayout=this.options.layout;this.loaded=!1;this.focusOnHover=this.options.focusOnHover;this.isStuck=this.cloneTimer=this.focusTimer=!1;this.initialize()}d.prototype.Defaults={layout:"rb-navbar-static",deviceLayout:"rb-navbar-fixed",focusOnHover:!0,focusOnHoverTimeout:800,linkedElements:["html"],
    domAppend:!0,stickUp:!0,stickUpClone:!0,stickUpOffset:"100%",anchorNavSpeed:400,anchorNavOffset:0,anchorNavEasing:"swing",responsive:{0:{layout:"rb-navbar-fixed",focusOnHover:!1,stickUp:!1},992:{layout:"rb-navbar-static",focusOnHover:!0,stickUp:!0}},callbacks:{onToggleSwitch:!1,onToggleClose:!1,onDomAppend:!1,onDropdownOver:!1,onDropdownOut:!1,onDropdownToggle:!1,onDropdownClose:!1,onStuck:!1,onUnstuck:!1,onAnchorChange:!1}};d.prototype.initialize=function(){this.$element.addClass("rb-navbar").addClass(this.options.layout);
    f&&this.$element.addClass("rb-navbar--is-touch");this.options.domAppend&&this.createNav(this);this.options.stickUpClone&&this.createClone(this);this.applyHandlers(this);this.offset=this.$element.offset().top;this.height=this.$element.outerHeight();this.loaded=!0;return this};d.prototype.resize=function(a,b){var e,h;h=f?a.getOption("deviceLayout"):a.getOption("layout");e=a.$element.add(a.$clone);h===a.currentLayout&&a.loaded||(a.switchClass(e,a.currentLayout,h),null!=a.options.linkedElements&&c.grep(a.options.linkedElements,
    function(b,c){return a.switchClass(b,a.currentLayout+"-linked",h+"-linked")}),a.currentLayout=h);a.focusOnHover=a.getOption("focusOnHover");return a};d.prototype.stickUp=function(a,b){var e,h,d,g;h=a.getOption("stickUp");e=a.$doc.scrollTop();g=null!=a.$clone?a.$clone:a.$element;d=a.getOption("stickUpOffset");d="string"===typeof d?0<d.indexOf("%")?parseFloat(d)*a.height/100:parseFloat(d):d;if(h){if(e>=d&&!a.isStuck||e<d&&a.isStuck)if(a.$element.add(a.$clone).find("[data-rb-navbar-toggle]").each(function(){c.proxy(a.closeToggle,
        this)(a,!1)}).end().find(".rb-navbar-submenu").removeClass("opened").removeClass("focus"),e>=d&&!a.isStuck)"resize"===b.type?a.switchClass(g,"","rb-navbar--is-stuck"):g.addClass("rb-navbar--is-stuck"),a.isStuck=!0,a.options.callbacks.onStuck&&a.options.callbacks.onStuck.call(a);else{if("resize"===b.type)a.switchClass(g,"rb-navbar--is-stuck","");else g.removeClass("rb-navbar--is-stuck").one("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd",c.proxy(a.resizeWrap,a,b));a.isStuck=!1;a.options.callbacks.onUnstuck&&
a.options.callbacks.onUnstuck.call(a)}}else a.isStuck&&(a.switchClass(g,"rb-navbar--is-stuck",""),a.isStuck=!1,a.resizeWrap(b));return a};d.prototype.resizeWrap=function(a){var b;if(null==this.$clone&&!this.isStuck)return b=this.$element.parent(),this.height=this.$element.outerHeight(),"resize"===a.type?(b.addClass("rb-navbar--no-transition").css("height",this.height),b[0].offsetHeight,b.removeClass("rb-navbar--no-transition")):b.css("height",this.height)};d.prototype.createNav=function(a){a.$element.find(".rb-navbar-dropdown, .rb-navbar-megamenu").each(function(){var a;
    a=c(this);return a.hasClass("rb-navbar-megamenu")?a.parent().addClass("rb-navbar--has-megamenu"):a.parent().addClass("rb-navbar--has-dropdown")}).parents("li").addClass("rb-navbar-submenu").append(c("<span/>",{"class":"rb-navbar-submenu-toggle"}));a.options.callbacks.onDomAppend&&a.options.callbacks.onDomAppend.call(this);return a};d.prototype.createClone=function(a){a.$clone=a.$element.clone().insertAfter(a.$element).addClass("rb-navbar--is-clone");return a};d.prototype.closeToggle=function(a,b){var e,
    d,f;e=c(b.target);d=!1;b.target!==this&&!e.parents("[data-rb-navbar-toggle]").length&&(f=this.getAttribute("data-rb-navbar-toggle"))&&(e=c(this).parents(".rb-navbar").find(f).add(c(this).parents(".rb-navbar")[0]),e.each(function(){if(!d)return d=!0===(b.target===this||c.contains(this,b.target))}),d||(e.add(this).removeClass("active"),a.options.callbacks.onToggleClose&&a.options.callbacks.onToggleClose.call(this,a)));return this};d.prototype.switchToggle=function(a,b){var e;b.preventDefault();if(e=
        this.getAttribute("data-rb-navbar-toggle"))c("[data-rb-navbar-toggle]").not(this).each(function(){var a;if(a=this.getAttribute("data-rb-navbar-toggle"))return c(this).parents(".rb-navbar").find(a).add(this).add(-1<c.inArray(".rb-navbar",a.split(/\s*,\s*/i))?c(this).parents(".rb-navbar")[0]:!1).removeClass("active")}),c(this).parents(".rb-navbar").find(e).add(this).add(-1<c.inArray(".rb-navbar",e.split(/\s*,\s*/i))?c(this).parents(".rb-navbar")[0]:!1).toggleClass("active"),a.options.callbacks.onToggleSwitch&&
a.options.callbacks.onToggleSwitch.call(this,a);return this};d.prototype.dropdownOver=function(a,b){var e;a.focusOnHover&&!f&&(e=c(this),clearTimeout(b),e.addClass("focus").siblings().removeClass("opened").each(a.dropdownUnfocus),a.options.callbacks.onDropdownOver&&a.options.callbacks.onDropdownOver.call(this,a));return this};d.prototype.dropdownOut=function(a,b){var e;a.focusOnHover&&!f&&(e=c(this),e.one("mouseenter.navbar",function(){return clearTimeout(b)}),clearTimeout(b),b=setTimeout(c.proxy(a.dropdownUnfocus,
    ...
    return this};d.prototype.activateAnchor=function(a){var b,e,d,f,g,k;k=this.$doc.scrollTop();g=this.$win.height();b=this.$doc.height();a=this.getOption("anchorNavOffset");if(k+g>b-50)return b=c('[data-type="anchor"]').last(),b.length&&b.offset().top>=k&&(f="#"+b.attr("id"),e=c('.rb-navbar-nav a[href^="'+f+'"]').parent(),e.hasClass("active")||(e.addClass("active").siblings().removeClass("active"),this.options.callbacks.onAnchorChange&&this.options.callbacks.onAnchorChange.call(b[0],this))),b;g=c('.rb-navbar-nav a[href^="#"]').get();
    ...
    a));a.$element.add(a.$clone).find("[data-rb-navbar-toggle]").each(function(){var b;b=c(this);b.on(f?"touchstart":"click",c.proxy(a.switchToggle,this,a));return b.parents("body").on(f?"touchstart":"click",c.proxy(a.closeToggle,this,a))});a.$element.add(a.$clone).find(".rb-navbar-submenu").each(function(){var b,d;b=c(this);d=b.parents(".rb-navbar--is-clone").length?a.cloneTimer:a.focusTimer;b.on("mouseleave.navbar",c.proxy(a.dropdownOut,this,a,d));b.find("> a").on("mouseenter.navbar",c.proxy(a.dropdownOver,
    this,a,d));b.find("> .rb-navbar-submenu-toggle").on(f?"touchstart":"click",c.proxy(a.dropdownToggle,this,a));return b.parents("body").on(f?"touchstart":"click",c.proxy(a.dropdownClose,this,a))});a.$element.add(a.$clone).find('.rb-navbar-nav a[href^="#"]').each(function(){return c(this).on(f?"touchstart":"click",c.proxy(a.goToAnchor,this,a))});return a};d.prototype.switchClass=function(a,b,d){a=a instanceof jQuery?a:c(a);a.addClass("rb-navbar--no-transition").removeClass(b).addClass(d);a[0].offsetHeight;
    return a.removeClass("rb-navbar--no-transition")};d.prototype.getOption=function(a){var b,c;for(b in this.options.responsive)b<=this.$win.width()&&(c=b);return null!=this.options.responsive[c][a]?this.options.responsive[c][a]:this.options[a]};return d}();c.fn.extend({RDNavbar:function(d){var a;a=c(this);if(!a.data("RDNavbar"))return a.data("RDNavbar",new l(this,d))}});return m.RDNavbar=l})(window.jQuery,document,window);"undefined"!==typeof module&&null!==module?module.exports=window.RDNavbar:"function"===
